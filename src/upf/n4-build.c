    ...
    upf_sess_t *sess, ogs_pfcp_pdr_t *created_pdr[], int num_of_created_pdr)
{
    ...
    /* When the SMF requested a 5GS-TSN-bridge port for this session, return the
     * assigned DS-TT port number in the standard PFCP created_bridge_info_for_tsc
     * IE (TS 29.244). 4-octet big-endian. */
    if (sess->nwtt.bridge) {
